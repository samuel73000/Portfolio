const propsProject = {
    ...
    objectives:[
      ...
      " As a member of the Argent Bank team, I played a key role in implementing user authentication using JWT and Axios for secure API calls. I led data management through Redux, enabling users to access and modify their information after login. We utilized Swagger for efficient API design and documentation, enhancing security, performance, and the user experience in the Argent Bank app. I also defined transaction routes in the Swagger editor, simplifying future management. Additionally, I optimized images for better app performance and created reusable components for good development practices.",
